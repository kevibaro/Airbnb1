...
function Supabase() {
  ...
  return (
    <>
      {/* 🔍 Buscador */}
      <div className="relative md:relative bottom-36 left-56 flex items-center justify-between w-full max-w-md md:max-w-xl rounded-full shadow-md border px-4 py-2 bg-white hover:shadow-lg transition-all cursor-pointer mx-auto mb-6">
